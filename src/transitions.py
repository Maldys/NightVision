...
transitions = {
    ...
    (State.MENU_CROSS, Fsm_Event.ENC_A_LEFT): (State.MENU_BATTERY_STATUS, menu_trans),#cross-view_mode main
    ...
    (State.MENU_SELECT_CONFIG, Fsm_Event.ENC_A_RIGHT): (State.MENU_BATTERY_STATUS, menu_trans),
    ...
    (State.MENU_BATTERY_STATUS, Fsm_Event.ENC_A_BTN): (State.MENU_BATTERY_STATUS_, battery_status),
    (State.MENU_BATTERY_STATUS, Fsm_Event.ENC_A_RIGHT): (State.MENU_CROSS, menu_trans),
    (State.MENU_BATTERY_STATUS, Fsm_Event.ENC_A_LEFT): (State.MENU_SELECT_CONFIG, menu_trans),
    (State.MENU_BATTERY_STATUS, Fsm_Event.MENU_BTN): (State.LIVE, save_ctx_trans),
    (State.MENU_BATTERY_STATUS_, Fsm_Event.MENU_BTN): (State.MENU_BATTERY_STATUS, battery_status),
}